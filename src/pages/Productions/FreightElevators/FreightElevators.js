...
import s from './FreightElevators.css';
...
export default class FreightElevators extends PureComponent {
  render() {
    return (
      <div>
        <Header />
        ...
        <section className="passenger-wrapper">
          <div className="passenger-box">
            <div className="passenger-info">
              ...
              <p>
                Компания «ДЛК» предлагает надежные грузовые лифты по
              ...
              <p>
                ...
                грузовые лифты. «ДЛК» — эксперт №1 на рынке подъемного
            ...
            <div className="lifts-item">
              ...
              <div className="lifts-info">
                <div className="info-header">
                  <h2 className="info-title">ГРУЗОВОЙ ЛИФТ OTIS 1000R</h2>
        ...
        <section className="rate-wrapper">
          <h2>Производители и стоимость грузовых лифтов</h2>
